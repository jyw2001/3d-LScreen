<template>
  <mars-dialog :draggable="false" left="10" top="10">
    <a-space>
      ...
      <mars-button @click="show('manage-layers')">图层管理</mars-button>
      <mars-button @click="show('sample-pannel')">展示s-pannel</mars-button>
      <mars-button @click="show('sample-dialog')">展示s-dialog</mars-button> -->
