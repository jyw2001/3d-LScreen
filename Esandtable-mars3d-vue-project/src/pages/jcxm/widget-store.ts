...
const store: StoreOptions<WidgetState> = {
  state: {
    widgets: [
      ...
      // {
      //   component: markRaw(defineAsyncComponent(() => import("@mars/widgets/basic/layer-manage/lm-2Dtilesset/index.vue"))),
      //   name: "lm-2Dtileset",
      //   group: "tools"
      // },
      // {
      //   component: markRaw(defineAsyncComponent(() => import("@mars/widgets/basic/layer-manage/lm-3Dtilesset/index.vue"))),
      //   name: "lm-3Dtileset",
      //   group: "tools"
      // }
      {
        component: markRaw(defineAsyncComponent(() => import("@mars/widgets/basic/login/index.vue"))),
        name: "login",
        group: "tools"
      }
    ],
